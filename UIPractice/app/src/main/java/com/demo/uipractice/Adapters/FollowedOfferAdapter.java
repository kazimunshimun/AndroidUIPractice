...
import com.demo.uipractice.Models.FollowedOfferData;
 ...
 */
public class FollowedOfferAdapter  extends RecyclerView.Adapter<FollowedOfferAdapter.ViewHolder>{

    Context mContext;

    public FollowedOfferAdapter(Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(view, new ViewHolder.CategoryItemClick() {
            ...
            public void onCard(View v, int position) {
                ...
                Offer offer = new FollowedOfferData().offerList().get(position);
    ...
    public int getItemCount() {
        return new FollowedOfferData().offerList().size();
    }
