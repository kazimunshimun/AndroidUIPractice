...
import com.demo.uipractice.Models.FeaturedOfferData;
 ...
 */
public class FeaturedOfferAdapter  extends RecyclerView.Adapter<FeaturedOfferAdapter.ViewHolder>{
    Context mContext;

    public FeaturedOfferAdapter(Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(view, new ViewHolder.CategoryItemClick() {
            ...
            public void onCard(View v, int position) {
                ...
                Offer offer = new FeaturedOfferData().offerList().get(position);
    ...
    public int getItemCount() {
        return new FeaturedOfferData().offerList().size();
    }
